...
- [Добро пожаловать в ИГРУ "ИСКАТЕЛЬ"](#добро-пожаловать-в-игру-искатель)
  ...
  - [История версий](#история-версий)
      ...
      - [1.0.2 от *23.12.2024*](#102-от-23122024)
  - [Планы](#планы)
...
Минимальный размер поля 10 клеток, а максимальный - 5000.
Кроме того, на поле может быть не более 100 рядов или колонок.
...
[Файлы для скачивания](https://github.com/Afatwist/seeker/releases/tag/v1.0.0 "Файлы для скачивания")
...
[Файлы для скачивания](https://github.com/Afatwist/seeker/releases/tag/v1.0.2 "Файлы для скачивания")

- Пользовательская информация:
	- Это обновление затронуло только конструктор:
  	- Минимальные размеры поля: 10 клеток, на поле обязательно должен быть хотя бы 1 ряд и 1 колонка.
  	- Максимальные размеры: 5000 клеток, максимум 100 рядов или колонок.
  	- При изменении размеров поля, а так же при сохранении, движок будет проверять эти требования.
- Техническая информация:
	- создан новый класс BoardSize для хранения требований и методов проверки.
